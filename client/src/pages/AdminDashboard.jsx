          ...
          <div className="p-6">
            ...
            {binsLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No bins configured</h3>
                <p className="text-gray-500 mb-6">Create your first storage bin location to organize inventory</p>
                <button
                  onClick={handleAddBin}
                  className="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors"
                >
